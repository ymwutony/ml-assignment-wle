...
```
Tidy up the training data by removing zero-variance predicators and non-predictive variables like ID, user_name and timestamp for the records.
```
...
```
caret::confusionMatrix(predictions, myValidation$classe)
```
